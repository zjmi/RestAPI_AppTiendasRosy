...
export function cardPaymentEmail (user, orderPay, subtotalLempiras, costoEnvioLempiras, totalLempiras, numeroPedido, numeroReferencia, items, tazaCambio, fecha, tienda, metodoEnvio, lugarEnvio){
    ...
    var mailOptions = {
        ...
        '<p>Hemos recibido tu pago, pronto se te enviara tu paquete.</p>'+
        ''+
